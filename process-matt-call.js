...
async function processMattCall() {
  console.log('Processing Matt\'s call with AI...\n');
  ...
  try {
    ...
    console.log('Qualified Lead:', call.is_qualified_lead ? 'YES' : 'NO');
    console.log('Contact Info:', call.contact_info || 'NOT SAVED');
