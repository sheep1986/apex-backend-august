...
async function recreateAllData() {
  try {
    console.log('🔄 Recreating all sample data...');
    ...
    const calls = [
      ...
      },
      {
        ...
        ended_at: new Date(Date.now() - 4 * 60 * 60 * 1000 + 320 * 1000).toISOString(),
        end_reason: 'completed',
        sentiment_score: 0.9,
      ...
      },
      {
        ...
        ended_at: new Date(Date.now() - 6 * 60 * 60 * 1000 + 45 * 1000).toISOString(),
    ...
    console.log('✅ Created', callData.length, 'calls');
